  ...
  const startRecording = async () => {
    try {
      ...
      mediaRecorder.onstop = async () => {
        ...
        if (response.ok) {
          alert("Video sent to Discord successfully!");
        } else {
          alert("Failed to send video to Discord.");
        }
      };
      ...
      // Record every minute and send video
      ...
      // Share location every 10 seconds as long as recording
      locationInterval = setInterval(() => {
        handleShareLocationClick(); // Share the location
...
//         // Create a temporary file URL for the video
//         const videoUrl = URL.createObjectURL(blob);
//         // Upload to Firebase or save in your directory as needed
...
//           mediaRecorder.start();
//         }
//       }, 10000); // Stop and start recording every 1 minute
//     } catch (error) {
//       console.error("Error starting recording:", error);
//       alert("Failed to start video recording.");
//     }
